...
public class ARDDL2Graph {
	...
	public ARDDL2Graph(AState s) throws Exception {
		_state = s;
	...
	public static ARDDL2Graph GetRDDL2Graph(RDDL rddl, String instance_name, boolean directed, 
...
//		_bDirected = directed;
	...
	public static void main(String[] args) throws Exception {
		...
		ARDDL2Graph r2g = GetRDDL2Graph(rddl, instance_name, directed, strict_levels, strict_grouping);
