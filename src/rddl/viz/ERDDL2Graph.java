...
public class ERDDL2Graph {
	...
	public ERDDL2Graph(EState s) throws Exception {
		_state = s;
	...
	public static ERDDL2Graph GetRDDL2Graph(RDDL rddl, String instance_name, boolean directed, 
...
//		_bDirected = directed;
	...
	public static void main(String[] args) throws Exception {
		...
		ERDDL2Graph r2g = GetRDDL2Graph(rddl, instance_name, directed, strict_levels, strict_grouping);
