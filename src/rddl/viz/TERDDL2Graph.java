...
public class TERDDL2Graph {
	...
	public TERDDL2Graph(TEState s) throws Exception {
		_state = s;
		// This call should only come from State which has not built the graph yet
		_graph = rddl2graph();
	}
	
	public static TERDDL2Graph GetRDDL2Graph(RDDL rddl, String instance_name, boolean directed, 
	...
	public static void main(String[] args) throws Exception {
		...
		TERDDL2Graph r2g = GetRDDL2Graph(rddl, instance_name, directed, strict_levels, strict_grouping);
