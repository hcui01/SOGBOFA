...
public class RDDL {
    ...
    {    
       ...
       try    
        {    
        o=(TYPE_NAME)super.clone();//Object
        }    
	...
	public static void ClearHash(){
		...
		ExpHash = null;
		ThresholdHash = null;
		PlusHash = new HashMap<Object, HashMap<Object, TreeExp>>();
		MinusHash = new HashMap<Object, HashMap<Object, TreeExp>>();
		TimesHash = new HashMap<Object, HashMap<Object, TreeExp>>();
		DividHash = new HashMap<Object, HashMap<Object, TreeExp>>();
		ExpHash = new HashMap<Object, HashMap<Object, TreeExp>>();
		ThresholdHash = new HashMap<Object, HashMap<Object, TreeExp>>();
	}
	...
	public abstract static class TYPE_DEF implements Cloneable, Serializable{
	...
	public abstract static class PVARIABLE_DEF implements Cloneable, Serializable{
...
//			}
	...
	public static class CPF_DEF implements Cloneable, Serializable{
	...
	public static class LVAR extends LTERM {
		...
		public boolean equals(Object o) {
			return _sVarName.equals(((LVAR)o)._sVarName); 
		}
		...
		public void collectGFluents(HashMap<LVAR, LCONST> subs,	AState s, HashSet<Pair> gfluents) 
				throws EvalException {
				// Nothing to collect
			}
		public void collectGFluents(HashMap<LVAR, LCONST> subs,	EState s, HashSet<Pair> gfluents) 
				throws EvalException {
				// Nothing to collect
			}
		public void collectGFluents(HashMap<LVAR, LCONST> subs,	TEState s, HashSet<Pair> gfluents) 
				throws EvalException {
				// Nothing to collect
			}
		...
		public Object sample(HashMap<LVAR, LCONST> subs, AState s, RandomDataGenerator r)
				throws EvalException {
					LCONST sub = subs.get(this);
					if (sub == null)
						throw new EvalException("RDDL.PVAR_EXPR: No substitution in " + subs + " for " + this + "\n" + this);
		...
		public Object sample(HashMap<LVAR, LCONST> subs, EState s, RandomDataGenerator r)
				throws EvalException {
					LCONST sub = subs.get(this);
					if (sub == null)
						throw new EvalException("RDDL.PVAR_EXPR: No substitution in " + subs + " for " + this + "\n" + this);
		...
		public Object sample(HashMap<LVAR, LCONST> subs, TEState s, RandomDataGenerator r)
				throws EvalException {
					LCONST sub = subs.get(this);
					if (sub == null)
						throw new EvalException("RDDL.PVAR_EXPR: No substitution in " + subs + " for " + this + "\n" + this);
		...
		public Object sample(HashMap<LVAR, LCONST> subs, TEState s, RandomDataGenerator r, 
				ArrayList<LTYPED_VAR> addVar, ArrayList<LCONST> addSub)
				throws EvalException {
					LCONST sub = subs.get(this);
					if (sub == null)
						throw new EvalException("RDDL.PVAR_EXPR: No substitution in " + subs + " for " + this + "\n" + this);
	...
	public abstract static class LCONST extends LTERM implements Cloneable, Serializable{
	...
	public static class TVAR_EXPR extends LTERM {
		...
		public Object sample(HashMap<LVAR,LCONST> subs, AState s, RandomDataGenerator r) throws EvalException {
			// Sample must be either an OBJECT_VAL or ENUM_VAL (both LCONST)
			LCONST result = null;
			try {
				result = (LCONST)_pvarExpr.sample(subs, s, r);
		...
		public Object sample(HashMap<LVAR,LCONST> subs, EState s, RandomDataGenerator r) throws EvalException {
			// Sample must be either an OBJECT_VAL or ENUM_VAL (both LCONST)
			LCONST result = null;
			try {
				result = (LCONST)_pvarExpr.sample(subs, s, r);
	...
	// Immutable... making public to avoid unnecessary
	// method calls, relying on user to respect immutability
	public static class TYPE_NAME implements Cloneable, Serializable{
		...
		// Name was interned so can check reference equality
		public boolean equals(Object o) {
			return _STypeName.equals(((TYPE_NAME)o)._STypeName); 
		}
	}
	...
	// Immutable... making public to avoid unnecessary
	// method calls, relying on user to respect immutability
	public static class PVAR_NAME implements Comparable, Cloneable, Serializable{
		...
		// Name was interned so can check reference equality
		public boolean equals(Object o) {
			return _sPVarNameCanon.equals(((PVAR_NAME)o)._sPVarNameCanon)
	...
	public static abstract class EXPR implements Cloneable, Serializable{ 
		public Object clone()    
	     {    
	         Object o=null;    
	        try    
	         {    
	         o=(LCONST)super.clone();//Object 
	         }    
	        catch(CloneNotSupportedException e)    
	         {    
	             System.out.println(e.toString());    
		...
		public double getDouble(Object o) throws EvalException{
			if(o instanceof Boolean){
				...
				throw new EvalException("only in bool and double supported");
			}
		}
		...
		public abstract Object sample(HashMap<LVAR,LCONST> subs, AState s, RandomDataGenerator r) throws EvalException;
		public abstract Object sample(HashMap<LVAR,LCONST> subs, EState s, RandomDataGenerator r) throws EvalException;
		public abstract Object sample(HashMap<LVAR,LCONST> subs, TEState s, RandomDataGenerator r) throws EvalException;

		
		public abstract void collectGFluents(HashMap<LVAR,LCONST> subs, State s, HashSet<Pair> gfluents) throws EvalException;
		public abstract void collectGFluents(HashMap<LVAR,LCONST> subs, AState s, HashSet<Pair> gfluents) throws EvalException;
		public abstract void collectGFluents(HashMap<LVAR,LCONST> subs, EState s, HashSet<Pair> gfluents) throws EvalException;
		public abstract void collectGFluents(HashMap<LVAR,LCONST> subs, TEState s, HashSet<Pair> gfluents) throws EvalException;
	...
	public static class KronDelta extends EXPR {
		...
		public Object sample(HashMap<LVAR,LCONST> subs, EState s, RandomDataGenerator r) throws EvalException {
			...
			//if (!(o instanceof Integer) && !(o instanceof Boolean) && !(o instanceof ENUM_VAL /*enum*/))
			//	throw new EvalException("RDDL: KronDelta only applies to integer/boolean data, not " + (o == null ? null : o.getClass()) + ".\n" + this);
			if (!(o instanceof Expression || o instanceof Boolean || o instanceof Integer || o instanceof Double))
				throw new EvalException("RDDL: KRonDelta only applies to Expression or boolean or int data.\n" + this);
			return o;
		}
		...
		public Object sample(HashMap<LVAR,LCONST> subs, TEState s, RandomDataGenerator r) throws EvalException {
			...
			//if (!(o instanceof Integer) && !(o instanceof Boolean) && !(o instanceof ENUM_VAL /*enum*/))
			//	throw new EvalException("RDDL: KronDelta only applies to integer/boolean data, not " + (o == null ? null : o.getClass()) + ".\n" + this);
			if (!(o instanceof TreeExp || o instanceof Boolean || o instanceof Integer || o instanceof Double))
				throw new EvalException("RDDL: KRonDelta only applies to Expression or boolean or int data.\n" + this);
			return o;
		}
	...
	public static class Uniform extends EXPR {
		...
		public Object sample(HashMap<LVAR,LCONST> subs, TEState s, RandomDataGenerator r) throws EvalException {
			throw new EvalException ("RDDL: uniform not supported");
		}
	...
	public static class Dirichlet extends EXPR {
		...
		public Object sample(HashMap<LVAR, LCONST> subs, AState s,
				RandomDataGenerator r) throws EvalException {
		...
		public Object sample(HashMap<LVAR, LCONST> subs, EState s,
				RandomDataGenerator r) throws EvalException {
		...
		public Object sample(HashMap<LVAR, LCONST> subs, TEState s,
				RandomDataGenerator r) throws EvalException {
	...
	public static class Bernoulli extends BOOL_EXPR implements Cloneable, Serializable {
		...
		public Object sample(HashMap<LVAR,LCONST> subs, EState s, RandomDataGenerator r) throws EvalException {
			Object prob = _exprProb.sample(subs, s, r);
			if (!(prob instanceof Expression || prob instanceof Double)) {
	...
	public static class OPER_EXPR extends EXPR {
		...
		public Object sample(HashMap<LVAR,LCONST> subs, AState s, RandomDataGenerator r) throws EvalException {
			...
			try {
				Object o1 = _e1.sample(subs, s, r);
				if(_op.equals(OPER_EXPR.TIMES) && ((Double)o1 == 0.0)){
					return o1;
				}
				Object o2 = _e2.sample(subs, s, r);				
				return ComputeArithmeticResult(o1, o2, _op);
		...
		public Object sample(HashMap<LVAR,LCONST> subs, EState s, RandomDataGenerator r) throws EvalException {
			...
			if (_op.equals(OPER_EXPR.TIMES)) {
				...
				Expression o1 = null;
				try { // FIXME: using Exceptions here for standard control-flow, should allow sample to return null
					o1 = s.toExpression(_e1.sample(subs, s, r));
				} catch (Exception e) { /* ignore here */ }
				if (o1 != null && (o1._exp.size() == 0 && o1._const == 0.0)) 
					return o1;
				
				Expression o2 = null;
				try { // FIXME: using Exceptions here for standard control-flow, should allow sample to return null
					o2 = s.toExpression(_e2.sample(subs, s, r));
				} catch (Exception e) { /* ignore here */ }
				if (o2 != null && (o2._exp.size() == 0 && o2._const == 0.0))
					return o2;
			}
			
			try {
				Expression o1 = s.toExpression(_e1.sample(subs, s, r));
				if(_op.equals(OPER_EXPR.TIMES) && (o1._exp.size() == 0 && o1._const == 0.0)){
					return o1;
				}
				Expression o2 = s.toExpression(_e2.sample(subs, s, r));				
				return ComputeArithmeticResult(o1, o2, _op);
			} catch (EvalException e) {
				throw new EvalException(e + "\n" + this);
			}
		...
		public void collectGFluents(HashMap<LVAR, LCONST> subs,	AState s, HashSet<Pair> gfluents) 
				...
				boolean e1_is_indep_of_state = local_fluents.size() == 0;
				if (e1_is_indep_of_state && _e1._bDet)
					e1_eval = getDouble(_e1.sample(subs, s, null));
				...
				boolean e2_is_indep_of_state = local_fluents.size() == 0;
				if (e2_is_indep_of_state && _e2._bDet)
					e2_eval = getDouble(_e2.sample(subs, s, null));
				
				if (_op.equals(OPER_EXPR.TIMES) && 
						(e1_eval == 0.0) || e2_eval == 0.0)
					return; // We have a state-independent 0 times some value... the result must be 0 so we need not collect fluents
		...
		public void collectGFluents(HashMap<LVAR, LCONST> subs,	EState s, HashSet<Pair> gfluents) 
				...
				Expression e1_eval = null;
				local_fluents.clear();
				_e1.collectGFluents(subs, s, local_fluents);
				boolean e1_is_indep_of_state = local_fluents.size() == 0;
				if (e1_is_indep_of_state && _e1._bDet)
					e1_eval = s.toExpression(_e1.sample(subs, s, null));

				Expression e2_eval = null;
				local_fluents.clear();
				_e2.collectGFluents(subs, s, local_fluents);
				boolean e2_is_indep_of_state = local_fluents.size() == 0;
				if (e2_is_indep_of_state && _e2._bDet)
					e2_eval = s.toExpression(_e2.sample(subs, s, null));
				
				if (_op.equals(OPER_EXPR.TIMES) && 
						((e1_eval != null && (e1_eval._exp.size() == 0 && e1_eval._const == 0.0)) ||
						 (e2_eval != null && (e2_eval._exp.size() == 0 && e2_eval._const == 0.0))))
					return; // We have a state-independent 0 times some value... the result must be 0 so we need not collect fluents
			...
			public void collectGFluents(HashMap<LVAR, LCONST> subs,	TEState s, HashSet<Pair> gfluents) 
				...
				TreeExp e1_eval = null;
				local_fluents.clear();
				_e1.collectGFluents(subs, s, local_fluents);
				boolean e1_is_indep_of_state = local_fluents.size() == 0;
				if (e1_is_indep_of_state && _e1._bDet)
					e1_eval = s.toTExp(_e1.sample(subs, s, null), null);

				TreeExp e2_eval = null;
				local_fluents.clear();
				_e2.collectGFluents(subs, s, local_fluents);
				boolean e2_is_indep_of_state = local_fluents.size() == 0;
				if (e2_is_indep_of_state && _e2._bDet)
					e2_eval = s.toTExp(_e2.sample(subs, s, null), null);
	...
	public static Object ComputeArithmeticResult(Object o1, Object o2, String op) throws EvalException {
		...
		if(Global.ifLift){
			if(op.equals(OPER_EXPR.PLUS)){
				if(PlusHash.containsKey(o1) && PlusHash.get(o1).containsKey(o2)){
					//System.out.println("hit");
					return PlusHash.get(o1).get(o2);
				}
				if(PlusHash.containsKey(o2) && PlusHash.get(o2).containsKey(o1)){
					//System.out.println("hit");
					return PlusHash.get(o2).get(o1);
				}
			}
			
			if(op.equals(OPER_EXPR.MINUS)){
				if(MinusHash.containsKey(o1) && MinusHash.get(o1).containsKey(o2)){
					//System.out.println("hit");
					return MinusHash.get(o1).get(o2);
				}
			}
			
			if(op.equals(OPER_EXPR.TIMES)){
				if(TimesHash.containsKey(o1) && TimesHash.get(o1).containsKey(o2)){
					//System.out.println("hit");
					return TimesHash.get(o1).get(o2);
				}
				if(TimesHash.containsKey(o2) && TimesHash.get(o2).containsKey(o1)){
					//System.out.println("hit");
					return TimesHash.get(o2).get(o1);
				}
			}
			
			if(op.equals(OPER_EXPR.DIV)){
				if(DividHash.containsKey(o1) && DividHash.get(o1).containsKey(o2)){
					//System.out.println("hit");
					return DividHash.get(o1).get(o2);
				}
			}
		}
		...
		if(Global.ifRecordLift){
			if(op.equals(OPER_EXPR.PLUS)){
				...
				PlusHash.get(o1).put(o2, res);
				
			}
			if(op.equals(OPER_EXPR.MINUS)){
				if(!MinusHash.containsKey(o1)){
					MinusHash.put(o1, new HashMap<Object, TreeExp>());
				}
				MinusHash.get(o1).put(o2, res);
			}
			if(op.equals(OPER_EXPR.TIMES)){
				if(!TimesHash.containsKey(o1)){
					TimesHash.put(o1, new HashMap<Object, TreeExp>());
				}
				TimesHash.get(o1).put(o2, res);
			}
			if(op.equals(OPER_EXPR.DIV)){
				if(!DividHash.containsKey(o1)){
					DividHash.put(o1, new HashMap<Object, TreeExp>());
				}
	...
	public static class AGG_EXPR extends EXPR {
		...
		public Object sample(HashMap<LVAR,LCONST> subs, EState s, RandomDataGenerator r) throws EvalException {
			...
			for (ArrayList<LCONST> sub_inst : possible_subs) {
				...
				if (result == null)
					...
					result = s.toExpression(ComputeArithmeticResult(result, interm_result, OPER_EXPR.PLUS));
				else if (_op.equals(PROD))
					result = s.toExpression(ComputeArithmeticResult(result, interm_result, OPER_EXPR.TIMES));
				else // op == MIN || op == MAX
					result = s.toExpression(ComputeArithmeticResult(result, interm_result, _op)); // same String
			}
		...
		public Object sample(HashMap<LVAR,LCONST> subs, TEState s, RandomDataGenerator r) throws EvalException {
			...
			// Evaluate all possible substitutions
			ArrayList<TreeExp> groupInterms = new ArrayList<>();
			boolean ifGourp = false;
			if(Policy.groupMode && _op.equals(SUM)) {
				ifGourp = true;
			}
			for (ArrayList<LCONST> sub_inst : possible_subs) {
				for (int i = 0; i < _alVariables.size(); i++) {
				...
				if(ifGourp) {
					groupInterms.add((TreeExp)interm_result);
					continue;
				}
				if (DEBUG_EXPR_EVAL)
					System.out.println(" - " + subs + " : " + interm_result);
				...
				if (result == null)
					...
					result = TEState.toTExp(ComputeArithmeticResult(result, interm_result, OPER_EXPR.PLUS), null);
				else if (_op.equals(PROD))
					result = TEState.toTExp(ComputeArithmeticResult(result, interm_result, OPER_EXPR.TIMES), null);
				else // op == MIN || op == MAX
					result = TEState.toTExp(ComputeArithmeticResult(result, interm_result, _op), null); // same String
			}
			
			if(ifGourp) {
				TreeExp groupResult = new TreeExp();
				groupResult.expType = "SUM";
				if(groupResult.subExp == null) {
					groupResult.subExp = new ArrayList<>();
				}
				for(TreeExp ints: groupInterms) {
					groupResult.subExp.add(ints);
					if(ints.father == null) {
						ints.father = new ArrayList<>();
					}
					ints.father.add(groupResult);
				}
				result = groupResult;
			}
		...
		public void collectGFluents(HashMap<LVAR, LCONST> subs,	AState s, HashSet<Pair> gfluents) 
				...
				if (_op.equals(PROD)) {
					...
					for (ArrayList<LCONST> sub_inst : possible_subs) {
						...
						if (expr_is_indep_of_state && _e._bDet) { // (s.getPVariableType(p._pName) == State.NONFLUENT) {
							double eval = getDouble(_e.sample(subs, s, null));
							if (eval == 0.0) {
		...
		public void collectGFluents(HashMap<LVAR, LCONST> subs,	EState s, HashSet<Pair> gfluents) 
				...
				if (_op.equals(PROD)) {
					...
					for (ArrayList<LCONST> sub_inst : possible_subs) {
						...
						if (expr_is_indep_of_state && _e._bDet) { // (s.getPVariableType(p._pName) == State.NONFLUENT) {
							Expression eval = s.toExpression(_e.sample(subs, s, null));
							if (eval._exp.size() == 0 && eval._const == 0.0) {
		...
		public void collectGFluents(HashMap<LVAR, LCONST> subs,	TEState s, HashSet<Pair> gfluents) 
				...
				if (_op.equals(PROD)) {
					...
					for (ArrayList<LCONST> sub_inst : possible_subs) {
						...
						if (expr_is_indep_of_state && _e._bDet) { // (s.getPVariableType(p._pName) == State.NONFLUENT) {
							TreeExp eval = s.toTExp(_e.sample(subs, s, null), null);
							if (eval.term != null && eval.term.var == -1 && eval.term.coefficient == 0.0) {
	...
	public static class PVAR_EXPR extends BOOL_EXPR {
		...
		public Object sample(HashMap<LVAR,LCONST> subs, TEState s, RandomDataGenerator r) throws EvalException {
			...
			Object ret_val = s.getPVariableAssign(_pName, _alTerms, _subTerms, subs);
			if (ret_val == null)
				throw new EvalException("RDDL.PVAR_EXPR: No value assigned to pvariable '" + 
						_pName + _subTerms + "'" + (_subTerms.size() == 0 ? "\n... did you intend an enum value @" + _pName+ " or object value $" + _pName + "?" : "") + "");
		...
		public void sampleLTerms(ArrayList<LCONST> ret_val, ArrayList<LTERM> to_sample, 
				HashMap<LVAR,LCONST> subs, AState s, RandomDataGenerator r) throws EvalException {
		...
		public void sampleLTerms(ArrayList<LCONST> ret_val, ArrayList<LTERM> to_sample, 
				HashMap<LVAR,LCONST> subs, EState s, RandomDataGenerator r) throws EvalException {
		...
		public LCONST CheckChildren(HashMap<LVAR,LCONST> subs, LVAR t, TYPE_NAME tn){
			LVAR theVar = Policy.LVARRecord.get(tn);
			if(subs.containsKey(theVar)){
				return subs.get(theVar);
			}
			if(Policy.childClass.containsKey(tn)){
				for(TYPE_NAME theChild: Policy.childClass.get(tn)){
					LCONST res = CheckChildren(subs,theVar, theChild);
					if(res != null){
						return res;
					}
				}
		...
		public LCONST UpdateSubs(HashMap<LVAR,LCONST> subs, LVAR t){
			TYPE_NAME tn = Policy.TYPERecord.get(t);
			TYPE_NAME loopTn = tn;
			LVAR loopLVAR = Policy.LVARRecord.get(loopTn);
			//check ancester
			while(Policy.superClass.containsKey(loopTn)){
				loopTn = Policy.superClass.get(loopTn).get(0);
				loopLVAR = Policy.LVARRecord.get(loopTn);
				if(subs.containsKey(loopLVAR)){
					return subs.get(loopLVAR);
				}
			}
			//check children
			LCONST res = CheckChildren(subs, t, tn);
		...
		public void sampleLTerms(ArrayList<LCONST> ret_val, ArrayList<LTERM> to_sample, 
				HashMap<LVAR,LCONST> subs, TEState s, RandomDataGenerator r) throws EvalException {
	...
	public static class FUN_EXPR extends EXPR {
		...
		public Object sample(HashMap<LVAR,LCONST> subs, AState s, RandomDataGenerator r) throws EvalException {		
			...
			throw new EvalException("ERROR: AState not support function expr yet"); 
		}

		public Object sample(HashMap<LVAR, LCONST> subs, EState s,
				RandomDataGenerator r) throws EvalException {

			throw new EvalException("ERROR: EState not support function expr yet"); 
		}
	...
	public static class IF_EXPR extends EXPR { 
		...
		public Object sample(HashMap<LVAR,LCONST> subs, AState s, RandomDataGenerator r) throws EvalException {
			...
			double val = getDouble(test);
			return val * getDouble(_trueBranch.sample(subs, s, r)) + (1-val) * getDouble(_falseBranch.sample(subs, s, r));
		}
		
		public Object sample(HashMap<LVAR,LCONST> subs, EState s, RandomDataGenerator r) throws EvalException {
			Object test = _test.sample(subs, s, r);
			if(!(test instanceof Expression)){
				test = new Expression(EState.getDouble(test));
			}
		...
		public void collectGFluents(HashMap<LVAR, LCONST> subs,	AState s, HashSet<Pair> gfluents) throws EvalException {
			throw new EvalException("Cannot work on collectGFluents on AStates");
				
		}
		
		public void collectGFluents(HashMap<LVAR, LCONST> subs,	EState s, HashSet<Pair> gfluents) throws EvalException {
			throw new EvalException("Cannot work on collectGFluents on AStates");
				
		}
		
		public void collectGFluents(HashMap<LVAR, LCONST> subs,	TEState s, HashSet<Pair> gfluents) throws EvalException {
			throw new EvalException("Cannot work on collectGFluents on AStates");
	...
	// (no int/real vars).
	public abstract static class BOOL_EXPR extends EXPR implements Cloneable, Serializable{ 
	...
	public static class QUANT_EXPR extends BOOL_EXPR {
		...
		public Object sample(HashMap<LVAR,LCONST> subs, AState s, RandomDataGenerator r) throws EvalException {
			...
			for (ArrayList<LCONST> sub_inst : possible_subs) {
				...
				// Update result
				double interm_result = getDouble(_expr.sample(subs, s, r));
				//System.out.println("Quant " + _sQuantType + " [" + subs + "]" + result + "/" + interm_result); 
				if (DEBUG_EXPR_EVAL)
					System.out.println(subs + " : " + interm_result);
				
				result *= (_sQuantType.equals(FORALL)) ? interm_result 
 						 : (1-interm_result);
				
				// Early cutoff detection
				if (_sQuantType.equals(FORALL) && result == 0)
					return 0.0;
				else if (_sQuantType.equals(EXISTS) && result == 0) // exists
					return 1.0;
			}
			// Clear all substitutions
			for (int i = 0; i < _alVariables.size(); i++) {
		...
		public Object sample(HashMap<LVAR,LCONST> subs, EState s, RandomDataGenerator r) throws EvalException {
			...
			Expression result = new Expression(1.0);
			...
			for (ArrayList<LCONST> sub_inst : possible_subs) {
				...
				if(_sQuantType.equals(FORALL)){
					result = s.toExpression(ComputeArithmeticResult(result, interm_result, "*"));
				}
				else{
					result = s.toExpression(ComputeArithmeticResult(result, ComputeArithmeticResult(1, interm_result, "-"), "*"));
				}
				
				// Early cutoff detection
				if (_sQuantType.equals(FORALL) && result._exp.size() == 0 && result._const == 0)
					return 0.0;
				else if (_sQuantType.equals(EXISTS) && result._exp.size() == 0 && result._const == 0) // exists
					return 1.0;
			}
			// Clear all substitutions
			for (int i = 0; i < _alVariables.size(); i++) {
		...
		public Object sample(HashMap<LVAR,LCONST> subs, TEState s, RandomDataGenerator r) throws EvalException {
			...
			for (ArrayList<LCONST> sub_inst : possible_subs) {
				...
				// Update result
				Object interm_result = _expr.sample(subs, s, r);
				//System.out.println("Quant " + _sQuantType + " [" + subs + "]" + result + "/" + interm_result); 
				if (DEBUG_EXPR_EVAL)
					System.out.println(subs + " : " + interm_result);
				...
				if(_sQuantType.equals(FORALL)){
					...
					result = TEState.toTExp(ComputeArithmeticResult(result, ComputeArithmeticResult(1, interm_result, "-"), "*"), null);
				}
				
				// Early cutoff detection
				if (_sQuantType.equals(FORALL) && result.term != null && result.term.var == -1 && result.term.coefficient == 0.0)
					return 0.0;
				else if (_sQuantType.equals(EXISTS) && result.term != null && result.term.var == -1 && result.term.coefficient == 0.0) // exists
					return 1.0;
			}
			// Clear all substitutions
			for (int i = 0; i < _alVariables.size(); i++) {
		...
		public Object sample(HashMap<LVAR,LCONST> subs, TEState s, RandomDataGenerator r, 
				ArrayList<LTYPED_VAR> addVar, ArrayList<LCONST> addSub) throws EvalException {
			...
			_alVariables.addAll(addVar);
			for(ArrayList<LCONST> theSub: possible_subs){
				theSub.addAll(addSub);
			}
			...
			for (ArrayList<LCONST> sub_inst : possible_subs) {
				...
				if (_expr._bDet) { // (s.getPVariableType(p._pName) == State.NONFLUENT) {
					TreeExp eval = TreeExp.BuildNewTreeExp(getDouble(1), null);
	...
	public static class CONN_EXPR extends BOOL_EXPR {
		...
		public Object sample(HashMap<LVAR,LCONST> subs, AState s, RandomDataGenerator r) throws EvalException {
			...
			// First check for early termination even if some args are null -- collectGfluents requires this
			if (_sConn == IMPLY || _sConn == EQUIV) {
				double b1 = -1;
				try { // FIXME: should not rely on Exception for control-flow, sample should be modified to return null
					b1 = getDouble(_alSubNodes.get(0).sample(subs, s, r));
				} catch (Exception e) { /* ignore */ }

				double b2 = -1;
				try { // FIXME: should not rely on Exception for control-flow, sample should be modified to return null
					b2 = getDouble(_alSubNodes.get(1).sample(subs, s, r));
				} catch (Exception e) { /* ignore */ }
				
				if(_sConn == IMPLY){
					return 1.0 - b1 * (1.0 - b2);
				}
				else{
					return b1 * b2 + (1.0 - b1) * (1.0 - b2);
				}		
			}
			...
			double result = 1;
			for (BOOL_EXPR b : _alSubNodes) {
				double interm_result = getDouble(b.sample(subs, s, r));
				result *= (_sConn.equals(AND)) ? interm_result
						: (1 - interm_result);

				// Early cutoff detection
				if (_sConn.equals(AND) && result == 0.0)
					return 0.0;
				else if (_sConn.equals(OR) && result == 0.0) // exists
					return 1.0;
			}
			return (_sConn.equals(AND)) ? result : (1 - result);
		}
		
		public Object sample(HashMap<LVAR,LCONST> subs, EState s, RandomDataGenerator r) throws EvalException {
			
			if (_sConn.equals(IMPLY) || _sConn.equals(EQUIV)) {
				Object b1 = _alSubNodes.get(0).sample(subs, s, r);
				Object b2 = _alSubNodes.get(1).sample(subs, s, r);
				if(_sConn.equals(IMPLY)){
					//return 1 - b1 + b1 * b2;
					return ComputeArithmeticResult(ComputeArithmeticResult(1, b1, "-"), ComputeArithmeticResult(b1, b2, "*"), "+");
				}
				else{
					//return b1 * b2 + (1-b1) * (1-b2);
					return ComputeArithmeticResult(ComputeArithmeticResult(b1, b2, "*"),
							ComputeArithmeticResult(ComputeArithmeticResult(1, b1, "-"),
							ComputeArithmeticResult(1, b2, "-"), "*"), "+");
				}
			}
			...
			for (BOOL_EXPR b : _alSubNodes) {
				...
				// Early cutoff detection
				if (_sConn.equals(AND) && result._exp.size() == 0 && result._const == 0)
					return 0.0;
				else if (_sConn.equals(OR) && result._exp.size() == 0 && result._const == 0) // exists
					return 1.0;

			}
			return (_sConn.equals(AND)) ? result : ComputeArithmeticResult(1, result, "-");
		}
		...
		public Object sample(HashMap<LVAR,LCONST> subs, TEState s, RandomDataGenerator r) throws EvalException {
			...
			for (int i = 0; i < _alSubNodes.size(); i ++) {
				...
				if (_sConn.equals(AND) && result.term != null 
						&& result.term.var == -1 && result.term.coefficient == 0.0)
					return 0.0;
				else if (_sConn.equals(OR) && result.term != null 
						&& result.term.var == -1 && result.term.coefficient == 0.0) // exists
					return 1.0;
		...
		public void collectGFluents(HashMap<LVAR, LCONST> subs,	AState s, HashSet<Pair> gfluents) throws EvalException {
			throw new EvalException("conn_expr: collecte gfluents cannot work with AState");
		}
		
		public void collectGFluents(HashMap<LVAR, LCONST> subs,	EState s, HashSet<Pair> gfluents) throws EvalException {
			throw new EvalException("conn_expr: collecte gfluents cannot work with EState");
		}

		public void collectGFluents(HashMap<LVAR, LCONST> subs,	TEState s, HashSet<Pair> gfluents) throws EvalException {
			throw new EvalException("conn_expr: collecte gfluents cannot work with TEState");
		}
	...
	public static class NEG_EXPR extends BOOL_EXPR {
		...
		public Object sample(HashMap<LVAR,LCONST> subs, AState s, RandomDataGenerator r) throws EvalException {
			double b = getDouble(_subnode.sample(subs, s, r));
			return 1-b;
		}
		
		public Object sample(HashMap<LVAR,LCONST> subs, EState s, RandomDataGenerator r) throws EvalException {
			Object b = _subnode.sample(subs, s, r);
			return ComputeArithmeticResult(1, b, "-");
		}
	...
	public static class COMP_EXPR extends BOOL_EXPR {
		...
		void combinationUtil(ArrayList<ArrayList<Integer>> results, int arr[], int data[], int start, int end, int index, int r) {
			// Current combination is ready to be printed, print it
			if (index == r) {
				results.add(new ArrayList<>());
				for(int i: data) {
					results.get(results.size() - 1).add(i);
				}
				return;
			}
		...
		public Object sample(HashMap<LVAR,LCONST> subs, TEState s, RandomDataGenerator r) throws EvalException {
			...
			if(o1 instanceof TreeExp || o2 instanceof TreeExp) {
				...
				if(o2 instanceof Integer) {
					t2 = TreeExp.BuildNewTreeExp((Integer)o2 + 0.0, null);
				}
				else {
					if(o2 instanceof Double) {
						t2 = TreeExp.BuildNewTreeExp((Double)o2, null);
					}
					else {
						if(o2 instanceof TreeExp) {
							t2 = (TreeExp)o2;
						}
						else {
							throw new EvalException("Unknown!!!");
						}
					}
				}
				
				if(o1 instanceof Integer) {
					t1 = TreeExp.BuildNewTreeExp((Integer)o1 + 0.0, null);
				}
				else {
					if(o1 instanceof Double) {
						t1 = TreeExp.BuildNewTreeExp((Double)o1, null);
					}
					else {
				...
				if(t1.expType.equals("LEA") && t1.term.var == -1 && t2.expType.equals("LEA") && t2.term.var == -1) {
					return ComputeCompResult(t1.term.coefficient, t2.term.coefficient, _comp);
				}
				
				Object theNum2 = tryParse(_e2.toString());
				Object theNum1 = tryParse(_e1.toString());
				
				if (theNum2 instanceof Integer && _comp.equals("==")) {
					// xxxx&&xxx == 1
					if ((_e1 instanceof CONN_EXPR || _e1 instanceof PVAR_EXPR || _e1 instanceof NEG_EXPR) && ((Integer) theNum2) == 1) {
						return t1;
					}

					// xxxx&&xxx == 0
					if ((_e1 instanceof CONN_EXPR || _e1 instanceof PVAR_EXPR || _e1 instanceof NEG_EXPR) && ((Integer) theNum2) == 0) {
			...
			throw new EvalException("Does not support this node eqal!!!");
		}
		...
		public static Object ComputeCompResult(Object o1, Object o2, String comp) throws EvalException {
			...
			if (o1 instanceof LCONST || o2 instanceof LCONST) {
				...
				return (comp.equals(EQUAL)) ? o1.equals(o2) : !o1.equals(o2);
			}
			...
			} else if (comp.equals(LESSEQ)) {
				return (v1 <= v2) ? TRUE : FALSE;				
			} else if (comp.equals(LESS)) {
				return (v1 < v2) ? TRUE : FALSE;
			} else if (comp.equals(GREATER)) {
				return (v1 > v2) ? TRUE : FALSE;
			} else if (comp.equals(GREATEREQ)) {
				return (v1 >= v2) ? TRUE : FALSE;
