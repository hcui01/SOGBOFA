...
public class RDDL implements Serializable {
	...
	public static class NONFLUENTS implements Serializable{
	...
	public abstract static class TYPE_DEF implements Serializable{
	...
	public static class ENUM_TYPE_DEF extends TYPE_DEF implements Serializable {
	...
	public static class OBJECT_TYPE_DEF extends TYPE_DEF implements Serializable {
	...
	public abstract static class PVARIABLE_DEF implements Serializable{
		...
		public Object clone()    
	     {    
	        ...
	        try    
	         {    
	         o=(PVARIABLE_DEF)super.clone();//Object 
	         }    
	        catch(CloneNotSupportedException e)    
	         {    
	             System.out.println(e.toString());    
	...
	public static class PVARIABLE_STATE_DEF extends PVARIABLE_DEF  implements Serializable{
	...
	public static class PVARIABLE_INTERM_DEF extends PVARIABLE_DEF implements Serializable {
	...
	public static class PVARIABLE_OBS_DEF extends PVARIABLE_DEF implements Serializable {
	...
	public static class PVARIABLE_ACTION_DEF extends PVARIABLE_DEF implements Serializable {
	...
	public static class CPF_HEADER_NAME  implements Serializable{
		public CPF_HEADER_NAME(String s) { _sName = s; }
		public String _sName;
		public String toString() { return _sName; }
	}
		
	public static class CPF_DEF implements Serializable {
	...
	public static abstract class LTERM extends EXPR  implements Serializable{ 
		public Object getTermSub(HashMap<LVAR, LCONST> subs, State s, Random r)
		throws EvalException {
			return sample(subs, s, r);
		}
		
		public Object getTermSub(HashMap<LVAR, LCONST> subs, AState s, Random r)
				throws EvalException {
					return sample(subs, s, r);
				}
		
		public Object getTermSub(HashMap<LVAR, LCONST> subs, EState s, Random r)
				throws EvalException {
					return sample(subs, s, r);
				}
		public Object getTermSub(HashMap<LVAR, LCONST> subs, TEState s, Random r)
				throws EvalException {
					return sample(subs, s, r);
				}
	}
			
	public static class LVAR extends LTERM implements Serializable {
		...
		public Object sample(HashMap<LVAR, LCONST> subs, AState s, Random r)
				throws EvalException {
					LCONST sub = subs.get(this);
					if (sub == null)
						throw new EvalException("RDDL.PVAR_EXPR: No substitution in " + subs + " for " + this + "\n" + this);
		...
		public Object sample(HashMap<LVAR, LCONST> subs, EState s, Random r)
				throws EvalException {
					LCONST sub = subs.get(this);
					if (sub == null)
						throw new EvalException("RDDL.PVAR_EXPR: No substitution in " + subs + " for " + this + "\n" + this);
		...
		public Object sample(HashMap<LVAR, LCONST> subs, TEState s, Random r)
				throws EvalException {
					LCONST sub = subs.get(this);
					if (sub == null)
						throw new EvalException("RDDL.PVAR_EXPR: No substitution in " + subs + " for " + this + "\n" + this);
	...
	public static class LTYPED_VAR extends LTERM implements Serializable {
	...
	public static class TVAR_EXPR extends LTERM implements Serializable{
...
public Object sample(HashMap<LVAR,LCONST> subs, AState s, Random r) throws EvalException {
		...
		public Object sample(HashMap<LVAR,LCONST> subs, EState s, Random r) throws EvalException {
		...
		public Object sample(HashMap<LVAR,LCONST> subs, TEState s, Random r) throws EvalException {
	...
	// Immutable... making public to avoid unnecessary
	// method calls, relying on user to respect immutability
	public static class ENUM_VAL extends LCONST implements Serializable {
	...
	// Immutable... making public to avoid unnecessary
	// method calls, relying on user to respect immutability
	public static class OBJECT_VAL extends LCONST  implements Serializable{
	...
	public static abstract class EXPR implements Serializable { 
		...
		public abstract Object sample(HashMap<LVAR,LCONST> subs, AState s, Random r) throws EvalException;
		public abstract Object sample(HashMap<LVAR,LCONST> subs, EState s, Random r) throws EvalException;
		public abstract Object sample(HashMap<LVAR,LCONST> subs, TEState s, Random r) throws EvalException;
	...
	public static class DiracDelta extends EXPR implements Serializable {
		...
		public Object sample(HashMap<LVAR,LCONST> subs, EState s, Random r) throws EvalException {
			Object o = _exprRealValue.sample(subs, s, r);
			if (!(o instanceof Expression || o instanceof Double))
				throw new EvalException("RDDL: DiracDelta only applies to Expression or double data.\n" + this);
				//o = (double)o;
			return o;
		}
		...
		public Object sample(HashMap<LVAR,LCONST> subs, TEState s, Random r) throws EvalException {
			Object o = _exprRealValue.sample(subs, s, r);
			if (!(o instanceof TreeExp || o instanceof Double))
				throw new EvalException("RDDL: DiracDelta only applies to Expression or double data.\n" + this);
				//o = (double)o;
			return o;
		}
	...
	public static class KronDelta extends EXPR implements Serializable {
	...
	public static class Uniform extends EXPR implements Serializable {
	...
	public static class Normal extends EXPR implements Serializable {
	...
	public static class Exponential extends EXPR implements Serializable {
	...
	public static class Discrete extends EXPR implements Serializable {
		...
		public Object sample(HashMap<LVAR,LCONST> subs, AState s, Random r) throws EvalException {
			throw new EvalException("RDDL: Sampling from Discrete not yet implemented in Agg State");
			/*
			try {
				ENUM_TYPE_DEF etd = (ENUM_TYPE_DEF)s._hmTypes.get(_sEnumType);
				ArrayList<ENUM_VAL> enum_label = new ArrayList<ENUM_VAL>();
	...
	public static class Geometric extends EXPR implements Serializable {
		...
		public Object sample(HashMap<LVAR,LCONST> subs, AState s, Random r) throws EvalException {
			throw new EvalException("RDDL: Sampling from Geometric not yet implemented in Agg State");
		}
	...
	public static class Poisson extends EXPR implements Serializable {
		...
		public Object sample(HashMap<LVAR,LCONST> subs, AState s, Random r) throws EvalException {
			throw new EvalException("RDDL: Sampling from Poisson not yet implemented in Agg State");
		}
	...
	public static class Bernoulli extends BOOL_EXPR implements Serializable {
	...
	public static class INT_CONST_EXPR extends EXPR implements Serializable {
	...
	public static class REAL_CONST_EXPR extends EXPR  implements Serializable{
	...
	public static class OPER_EXPR extends EXPR implements Serializable {
	...
	public static Object ComputeArithmeticResult(Object o1, Object o2, String op) throws EvalException {
		...
		if(o1 instanceof TreeExp && o2 instanceof TreeExp){
			...
			if (op.equals( OPER_EXPR.PLUS)){
				...
				return newTExp.ADD(newTExp2);
			}
			else if (op.equals(OPER_EXPR.MINUS)){
				TreeExp newTExp = (TreeExp)o1;
				TreeExp newTExp2 = (TreeExp)o2;
				return newTExp.MINUS(newTExp2);
			}
			else if (op.equals(OPER_EXPR.TIMES)){
				TreeExp newTExp = (TreeExp)o1;
				TreeExp newTExp2 = (TreeExp)o2;
				return newTExp.TIMES(newTExp2);
			}
			else{
				TreeExp newTExp = (TreeExp)o1;
				TreeExp newTExp2 = (TreeExp)o2;
				return newTExp.DIVID(newTExp2);
			}
		}
			...
			if((o1 instanceof Double || o1 instanceof Integer || o1 instanceof Long || o1 instanceof Boolean) && 
				...
				if((o1 instanceof Double || o1 instanceof Integer || o1 instanceof Long) && o2 instanceof TreeExp){
					TreeExp newTExp2 = (TreeExp)o2;
					TreeExp newTExp = new TreeExp(getDouble(o1), null);
					if (op.equals( OPER_EXPR.PLUS)){
						return newTExp.ADD(newTExp2);
					}
					else if (op.equals(OPER_EXPR.MINUS)){
					...
					if((o2 instanceof Double || o2 instanceof Integer || o2 instanceof Long) && o1 instanceof TreeExp){
						TreeExp newTExp = (TreeExp)o1;
						TreeExp newTExp2 = new TreeExp(getDouble(o2), null);
						if (op.equals( OPER_EXPR.PLUS)){
							return newTExp.ADD(newTExp2);
						}
						else if (op.equals(OPER_EXPR.MINUS)){
	...
	//*** this part only supports integer as results now
	//*** this is because only integer can be the results of boolean MDP
	//*** also because the result of it will be part of comparator, if we get number here, it would be hard to compare it
	public static class AGG_EXPR extends EXPR implements Serializable {
			...
			for (ArrayList<LCONST> sub_inst : possible_subs) {
				...
				if (result == null)
					...
					result = ComputeArithmeticResult(result, interm_result, 
							     _op.equals(SUM) ? OPER_EXPR.PLUS : OPER_EXPR.TIMES);
			}
		...
		public Object sample(HashMap<LVAR,LCONST> subs, EState s, Random r) throws EvalException {
			...
			for (ArrayList<LCONST> sub_inst : possible_subs) {
				...
				Expression interm_result = s.toExpression(_e.sample(subs, s, r));
				if (DEBUG_EXPR_EVAL)
					System.out.println(" - " + subs + " : " + interm_result);
		...
		public Object sample(HashMap<LVAR,LCONST> subs, TEState s, Random r) throws EvalException {
			...
			for (ArrayList<LCONST> sub_inst : possible_subs) {
				...
				TreeExp interm_result = s.toTExp(_e.sample(subs, s, r), null);
				if (DEBUG_EXPR_EVAL)
					System.out.println(" - " + subs + " : " + interm_result);
				...
				if (result == null)
					...
					result = s.toTExp(ComputeArithmeticResult(result, interm_result, 
							     _op.equals(SUM) ? OPER_EXPR.PLUS : OPER_EXPR.TIMES), null);
				//stop before head
				if(!_op.equals(SUM) && result.expType.equals("NOD")){
					break;
				}
			}
	...
	public static class PVAR_EXPR extends BOOL_EXPR implements Serializable {
		...
		public Object sample(HashMap<LVAR,LCONST> subs, EState s, Random r) throws EvalException {
			...
			Object ret_val = (Object)s.getPVariableAssign(_sName, _subTerms);
			if (ret_val == null)
				throw new EvalException("RDDL.PVAR_EXPR: No value assigned to pvariable '" + 
						_sName + _subTerms + "'" + (_subTerms.size() == 0 ? "\n... did you intend an enum value @" + _sName+ "?" : "") + "");
			return s.toExpression(ret_val);
		}
	...
	public static class IF_EXPR extends EXPR implements Serializable { 
		...
		public Object sample(HashMap<LVAR,LCONST> subs, AState s, Random r) throws EvalException {
			...
			if (!(test instanceof Double))
				throw new EvalException("RDDL.IF_EXPR: test " + _test + " did not evaluate to Double: " + test+ "\n" + this);
		...
		public Object sample(HashMap<LVAR,LCONST> subs, TEState s, Random r) throws EvalException {
			...
			if(!(test instanceof TreeExp)){
				test = new TreeExp(TEState.getDouble(test), null);
			}
			Object truebranch = _trueBranch.sample(subs, s, r);
			Object trueResult = ComputeArithmeticResult(test, truebranch, "*");
			Object falsebranch = _falseBranch.sample(subs, s, r);
	...
	//       a random sample should always be referenced by an intermediate
	//       variable so that it is consistent over repeated evaluations.
	public static class SWITCH_EXPR extends EXPR implements Serializable {
		...
		public Object sample(HashMap<LVAR,LCONST> subs, EState s, Random r) throws EvalException {
			...
			throw new EvalException("switch case not supported in this version yet: Astate");
		}
	...
	// (no int/real vars).
	public abstract static class BOOL_EXPR extends EXPR implements Serializable { 
	...
	//       a random sample should always be referenced by an intermediate
	//       variable so that it is consistent over repeated evaluations.
	public static class QUANT_EXPR extends BOOL_EXPR implements Serializable {
		...
		public Object sample(HashMap<LVAR,LCONST> subs, TEState s, Random r) throws EvalException {
			ArrayList<ArrayList<LCONST>> possible_subs = s.generateAtoms(_alVariables);
			TreeExp result = new TreeExp(getDouble(1), null);
			...
			for (ArrayList<LCONST> sub_inst : possible_subs) {
				...
				if(_sQuantType.equals(FORALL)){
					result = s.toTExp(ComputeArithmeticResult(result, interm_result, "*"), null);
				}
				else{
					result = s.toTExp(ComputeArithmeticResult(result, ComputeArithmeticResult(1, interm_result, "-"), "*"), null);
				}
								
				// Early cutoff detection
				if (_sQuantType.equals(FORALL) && result.expType.equals("NOD"))
					return 0.0;
				else if (_sQuantType.equals(EXISTS) && result.expType.equals("NOD")) // exists
					return 1.0;
			}
	...
	//       a random sample should always be referenced by an intermediate
	//       variable so that it is consistent over repeated evaluations.
	public static class CONN_EXPR extends BOOL_EXPR implements Serializable {
		...
		public Object sample(HashMap<LVAR,LCONST> subs, AState s, Random r) throws EvalException {
			...
			if (_sConn.equals(IMPLY) || _sConn.equals(EQUIV)) {
				double b1 = getDouble(_alSubNodes.get(0).sample(subs, s, r));
				double b2 = getDouble(_alSubNodes.get(1).sample(subs, s, r));
				if(_sConn.equals(IMPLY)){
					return 1 - b1 + b1 * b2;
				}
				else{
			...
			for (BOOL_EXPR b : _alSubNodes) {
				...
				result *= (_sConn.equals(AND)) ? interm_result : (1-interm_result);
		...
		public Object sample(HashMap<LVAR,LCONST> subs, TEState s, Random r) throws EvalException {
			...
			for (BOOL_EXPR b : _alSubNodes) {
				...
				// Early cutoff detection
				if (_sConn.equals(AND) && result.expType.equals("NOD"))
					return 0.0;
				else if (_sConn.equals(OR) && result.expType.equals("NOD")) // exists
					return 1.0;
		...
		public void collectGFluents(HashMap<LVAR, LCONST> subs,	State s, HashSet<Pair> gfluents) 
			...
			if (_sConn.equals(AND) || _sConn.equals(OR)) {
				for (BOOL_EXPR b : _alSubNodes) {
					if (b instanceof PVAR_EXPR) {
						...
						if (s.getPVariableType(p._sName) == 2) {
			...
			} else if (_sConn.equals(IMPLY) && _alSubNodes.get(0) instanceof PVAR_EXPR) {
	...
	//       a random sample should always be referenced by an intermediate
	//       variable so that it is consistent over repeated evaluations.
	public static class NEG_EXPR extends BOOL_EXPR implements Serializable {
	...
	public static class BOOL_CONST_EXPR extends BOOL_EXPR  implements Serializable{
	...
	public static class COMP_EXPR extends BOOL_EXPR implements Serializable {
		...
		//specially designed for gradient policy
		HashMap<String, Double> currentMarginal = new HashMap<String, Double>();
		
		public void SetMarginal(HashMap<String, Double> m){
			currentMarginal = m;
		}
		...
		public Object sample(HashMap<LVAR,LCONST> subs, State s, Random r) throws EvalException {
			...
			} else if (_comp.equals(LESSEQ)) {
				return (v1 <= v2) ? TRUE : FALSE;				
			} else if (_comp.equals(LESS)) {
				return (v1 < v2) ? TRUE : FALSE;
			} else if (_comp.equals(GREATER)) {
				return (v1 > v2) ? TRUE : FALSE;
			} else if (_comp.equals(GREATEREQ)) {
				return (v1 >= v2) ? TRUE : FALSE;
			} else if (_comp.equals(EQUAL)) {
				return (v1 == v2) ? TRUE : FALSE;
			} else
		...
		public Object sample(HashMap<LVAR,LCONST> subs, EState s, Random r) throws EvalException {
			...
			double v1 = o1.RealValue(currentMarginal);
			double v2 = o2.RealValue(currentMarginal);
	...
	public static class OBJ_COMP_EXPR extends BOOL_EXPR  implements Serializable{
	...
	public static class OBJECTS_DEF implements Serializable {
	...
	public static class PVAR_INST_DEF implements Serializable {
		
		public PVAR_INST_DEF(){
